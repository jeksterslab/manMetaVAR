...
- **Naive** was the fastest method, with a mean runtime of 13.12 seconds
  and a median runtime of 12.79 seconds.
- **MetaVAR** had a mean runtime of 44.54 seconds and a median runtime
  of 44.56 seconds.
- **BMLVAR** was the slowest method, with a mean runtime of 364.46
  seconds and a median runtime of 364.42 seconds.
...
MetaVAR required about 31.42 more seconds than Naive on this task,
whereas BMLVAR required about 319.91 more seconds than MetaVAR.
...
- **Naive** is the reference method, so its relative runtime is 1.00 by
  definition.
- **MetaVAR** had a mean relative runtime of 3.39, meaning that it took
  about 3 times as long as Naive.
- **BMLVAR** had a mean relative runtime of 27.77, meaning that it took
  about 28 times as long as Naive.

Put differently, BMLVAR took roughly 8.2 times as long as MetaVAR on
