...
- **Naive** was the fastest method, with a mean runtime of 10.25 seconds
  and a median runtime of 10.12 seconds.
- **MetaVAR** had a mean runtime of 77.98 seconds and a median runtime
  of 78.12 seconds.
- **BMLVAR** was the slowest method, with a mean runtime of 363.00
  seconds and a median runtime of 363.22 seconds.
...
MetaVAR required about 67.73 more seconds than Naive on this task,
whereas BMLVAR required about 285.03 more seconds than MetaVAR.
...
- **BMLVAR** had a mean relative runtime of 35.42, meaning that it took
