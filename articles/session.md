...
`#> [1] manMetaVAR_0.9.9     metaDyn_1.0.4        fitVARMxID_1.0.6    `\
...
`#>  [7] parallel_4.6.1       systemfonts_1.3.2    scales_1.4.0        `\
`#> [10] textshaping_1.0.5    lattice_0.22-9       ggplot2_4.0.3       `\
...
`#> [25] RcppParallel_6.2.1   otel_0.2.0           cli_3.6.6           `\
`#> [28] withr_3.0.3          magrittr_2.0.5       digest_0.6.39       `\
`#> [31] grid_4.6.1           rProject_0.0.25      lifecycle_1.0.5     `\
`#> [34] vctrs_0.7.3          simStateSpace_1.2.16 evaluate_1.0.5      `\
`#> [37] glue_1.8.1           farver_2.1.2         ragg_1.5.2          `\
`#> [40] tools_4.6.1          pkgconfig_2.0.3`

## CPU

\
[`cat`](https://rdrr.io/r/base/cat.html)`(`[`system`](https://rdrr.io/r/base/system.html)`(``"lscpu"``, intern ``=`` ``TRUE``)``, sep ``=`` ``"\n"``)`\
`#> Architecture:                            x86_64`\
...
\
[`cat`](https://rdrr.io/r/base/cat.html)`(`[`system`](https://rdrr.io/r/base/system.html)`(``"free -g -h -t"``, intern ``=`` ``TRUE``)``, sep ``=`` ``"\n"``)`\
`#>                total        used        free      shared  buff/cache   available`\
`#> Mem:            44Gi       5.8Gi        18Gi       119Mi        20Gi        38Gi`\
`#> Swap:           22Gi       3.0Mi        22Gi`\
`#> Total:          66Gi       5.8Gi        41Gi`
