...
summary(mplus)
#>                               est     se     R    2.5%   97.5%
#> theta[1,1]                 0.5061 0.0047 81000  0.4967  0.5152
#> theta[2,2]                 0.5015 0.0053 81000  0.4911  0.5117
#> psi[1,1]                   0.1961 0.0045 81000  0.1879  0.2053
#> psi[2,1]                  -0.0543 0.0023 81000 -0.0587 -0.0500
#> psi[2,2]                   0.1778 0.0052 81000  0.1678  0.1884
#> mean(nu[1,1])              0.5029 0.0240 81000  0.4560  0.5502
#> mean(nu[2,1])             -0.5307 0.0229 81000 -0.5759 -0.4859
#> mean(beta[1,1])            0.6830 0.0105 81000  0.6622  0.7029
#> mean(beta[2,1])           -0.1598 0.0107 81000 -0.1812 -0.1394
#> mean(beta[1,2])           -0.1709 0.0093 81000 -0.1895 -0.1546
#> mean(beta[2,2])            0.6424 0.0118 81000  0.6186  0.6645
#> cov(nu[1,1],nu[1,1])       0.0952 0.0118 81000  0.0756  0.1219
#> cov(nu[2,1],nu[1,1])      -0.0349 0.0085 81000 -0.0536 -0.0200
#> cov(nu[2,1],nu[2,1])       0.0895 0.0106 81000  0.0717  0.1131
#> cov(nu[1,1],beta[1,1])     0.0058 0.0030 81000  0.0002  0.0119
#> cov(nu[2,1],beta[1,1])    -0.0044 0.0027 81000 -0.0100  0.0008
#> cov(beta[1,1],beta[1,1])   0.0121 0.0014 81000  0.0097  0.0153
#> cov(nu[1,1],beta[2,1])     0.0024 0.0031 81000 -0.0036  0.0087
#> cov(nu[2,1],beta[2,1])    -0.0062 0.0030 81000 -0.0124 -0.0005
#> cov(beta[2,1], beta[1,1])  0.0100 0.0014 81000  0.0076  0.0132
#> cov(beta[2,1],beta[2,1])   0.0131 0.0018 81000  0.0102  0.0171
#> cov(nu[1,1],beta[1,2])    -0.0022 0.0020 81000 -0.0063  0.0016
#> cov(nu[2,1],beta[1,2])     0.0000 0.0021 81000 -0.0043  0.0038
#> cov(beta[1,2],beta[1,1])  -0.0033 0.0007 81000 -0.0048 -0.0020
#> cov(beta[1,2],beta[2,1])  -0.0005 0.0008 81000 -0.0020  0.0010
#> cov(beta[1,2],beta[1,2])   0.0050 0.0009 81000  0.0035  0.0070
#> cov(nu[1,1],beta[2,2])    -0.0016 0.0029 81000 -0.0074  0.0040
#> cov(nu[2,1],beta[2,2])    -0.0024 0.0029 81000 -0.0082  0.0031
#> cov(beta[2,2],beta[1,1])   0.0003 0.0011 81000 -0.0018  0.0026
#> cov(beta[2,2],beta[2,1])   0.0003 0.0012 81000 -0.0019  0.0028
#> cov(beta[2,2],beta[1,2])   0.0055 0.0009 81000  0.0040  0.0076
#> cov(beta[2,2],beta[2,2])   0.0111 0.0017 81000  0.0083  0.0149
```
