...
summary(mplus)
#>                               est     se      R    2.5%   97.5%
#> theta[1,1]                 0.5034 0.0127 481000  0.4913  0.5136
#> theta[2,2]                 0.5023 0.0156 481000  0.4908  0.5130
#> psi[1,1]                   0.1984 0.0184 481000  0.1886  0.2112
#> psi[2,1]                  -0.0531 0.0030 481000 -0.0578 -0.0484
#> psi[2,2]                   0.1765 0.0210 481000  0.1660  0.1883
#> mean(nu[1,1])              0.5044 0.0287 481000  0.4492  0.5598
#> mean(nu[2,1])             -0.5304 0.0262 481000 -0.5814 -0.4793
#> mean(beta[1,1])            0.6710 0.0210 481000  0.6246  0.6991
#> mean(beta[2,1])           -0.1590 0.0192 481000 -0.2022 -0.1306
#> mean(beta[1,2])           -0.1801 0.0206 481000 -0.2341 -0.1505
#> mean(beta[2,2])            0.6402 0.0248 481000  0.5865  0.6695
#> cov(nu[1,1],nu[1,1])       0.1107 0.1362 481000  0.0862  0.6169
#> cov(nu[2,1],nu[1,1])      -0.0404 0.0409 481000 -0.1518  0.0801
#> cov(nu[2,1],nu[2,1])       0.1028 0.0762 481000  0.0802  0.3772
#> cov(nu[1,1],beta[1,1])     0.0068 0.0315 481000 -0.0796  0.0527
#> cov(nu[2,1],beta[1,1])    -0.0024 0.0417 481000 -0.0740  0.1206
#> cov(beta[1,1],beta[1,1])   0.0175 0.0929 481000  0.0130  0.3580
#> cov(nu[1,1],beta[2,1])     0.0030 0.0726 481000 -0.3371  0.0284
#> cov(nu[2,1],beta[2,1])    -0.0090 0.0384 481000 -0.1259  0.0034
#> cov(beta[2,1], beta[1,1])  0.0103 0.0680 481000 -0.1379  0.1154
#> cov(beta[2,1],beta[2,1])   0.0165 0.1005 481000  0.0123  0.3610
#> cov(nu[1,1],beta[1,2])    -0.0032 0.0980 481000 -0.4724  0.0646
#> cov(nu[2,1],beta[1,2])     0.0019 0.0653 481000 -0.1175  0.1733
#> cov(beta[1,2],beta[1,1])  -0.0009 0.0838 481000 -0.3150  0.0849
#> cov(beta[1,2],beta[2,1])  -0.0015 0.0704 481000 -0.0940  0.2737
#> cov(beta[1,2],beta[1,2])   0.0091 0.1470 481000  0.0062  0.6229
#> cov(nu[1,1],beta[2,2])    -0.0012 0.0341 481000 -0.1269  0.0343
#> cov(nu[2,1],beta[2,2])    -0.0042 0.0561 481000 -0.1658  0.1695
#> cov(beta[2,2],beta[1,1])  -0.0008 0.0681 481000 -0.2573  0.0405
#> cov(beta[2,2],beta[2,1])   0.0020 0.0521 481000 -0.0282  0.2090
#> cov(beta[2,2],beta[1,2])   0.0052 0.0631 481000 -0.1164  0.2193
#> cov(beta[2,2],beta[2,2])   0.0147 0.1030 481000  0.0106  0.3732
```
